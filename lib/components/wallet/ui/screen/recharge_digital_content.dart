...
class RechargeDigitalContent extends StatefulWidget {
  @override
  _RechargeDigitalContentState createState() => _RechargeDigitalContentState();
}
class _RechargeDigitalContentState extends State<RechargeDigitalContent> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 30),
                    CustomSelectField(
                    label: 'Operador contenido digital',
                    ops: ['Netflix', 'HBO+', 'Prime Video', 'Directv', 'Otro'],
