                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'Utiliza esta opción para retirar dinero en cantidades que no superen los \$ 9.999.999 de pesos',
                                      maxLines: 2,
                                      style: TextStyle(
                                        fontFamily: 'Basic Commercial SR Pro',
                                        fontStyle: FontStyle.normal,
  ...
  showModal(BuildContext context) {
    return showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return ConfirmTransaction(contextOrigin: context, route: 'withdrawcashsuccess',);
        });
  }
