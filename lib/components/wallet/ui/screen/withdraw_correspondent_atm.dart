...
class WithdrawAtm extends StatefulWidget {
  @override
  _WithdrawAtmState createState() => _WithdrawAtmState();
}
class _WithdrawAtmState extends State<WithdrawAtm> {
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  'Retira multiplos de \$10.000, mayor o igual a \$20.000 y menor o igual a \$60.000',
                                  maxLines: 2,
                                  style: TextStyle(
                                    fontFamily: 'Basic Commercial SR Pro',
                                    fontStyle: FontStyle.normal,
                                ...
                                Text(
                                  'Puedes retirar un máximo de \$3’000.000 al día',
                                  maxLines: 2,
                                  style: TextStyle(
                                    fontFamily: 'Basic Commercial SR Pro',
                                    fontStyle: FontStyle.normal,
  ...
  showModal(BuildContext context) {
    return showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return ConfirmTransaction(contextOrigin: context, route: 'withdrawatmsuccess',);
        });
  }
